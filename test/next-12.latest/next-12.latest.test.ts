...
import type { createDynamicRouteParser as _ } from "next-router-mock/dynamic-routes/next-12";
import type { MemoryRouterProvider } from "next-router-mock/MemoryRouterProvider";
import type { MemoryRouterProvider as __ } from "next-router-mock/MemoryRouterProvider/next-12";
...
describe(`next version ${require("next/package.json").version}`, () => {
  describe("automatic and explicit import paths are valid", () => {
    ...
    it("next-router-mock/dynamic-routes/next-12", () => {
      require("next-router-mock/dynamic-routes/next-12");
    });
    ...
    it("next-router-mock/MemoryRouterProvider/next-12", () => {
      require("next-router-mock/MemoryRouterProvider/next-12");
    });
  });
});
